 ...
 */
exports.createAttachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, timestampOptions) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @returns подпись в формате PKCS#7
 */
exports.createDetachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, messageHash, timestampOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
 ...
 */
exports.getLicenseInfo = _afterPluginsLoaded_1._afterPluginsLoaded(() => {
    const getEmptyData = () => ({
        validTo: '',
        serialNumber: '',
        firstInstall: '',
    ...
    return eval(_generateCadesFn_1._generateCadesFn(function getLicenseInfo() {
        try {
            const cLic = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.CPLicense');
            info.csp = {
